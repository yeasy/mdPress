...
v0.3.0 ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░ 规划中（目标 2026-08）
v0.4.0 ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░ 规划中（目标 2026-11）
...
| 功能 | 优先级 | 说明 |
|------|--------|------|
| ePub 3 输出 | P1 | 生成标准 ePub 3 电子书，支持封面、目录、元数据 |
| 插件系统 | P1 | 支持 Markdown 预处理器和输出后处理器钩子 |
| LaTeX 数学公式 | P2 | 基于 KaTeX/MathJax 渲染行内和块级数学公式 |
| Mermaid 图表 | P2 | 内置 Mermaid 支持，PDF 中使用 SVG 渲染，HTML 中客户端渲染 |
| 多语言增强（i18n） | P1 | 在独立构建基础上补充语言入口页、语言切换和更完整的元数据处理 |
| HTML 全文搜索 | P1 | 基于 lunr.js 的客户端全文搜索 |
| 自定义字体嵌入 | P2 | 支持指定本地 TTF/OTF/WOFF2 字体文件 |
| PDF 书签 | P2 | 根据目录结构自动生成 PDF 书签（outline） |
...
- `pre-parse`：Markdown 解析前的文本预处理
- `post-parse`：HTML 生成后的内容后处理
- `post-build`：整体构建完成后的文件后处理

---

## v0.4.0 — Typst 后端与增量编译（规划中）
